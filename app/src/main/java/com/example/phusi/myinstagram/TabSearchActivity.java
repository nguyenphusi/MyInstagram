...
public class TabSearchActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
       ...
       /* getMenuInflater().inflate(R.menu.menu_tab_search, menu);
        ...
        inflater.inflate(R.menu.menu_tab_search, menu);
        // Associate searchable configuration with the SearchView
        SearchManager searchManager = (SearchManager) getSystemService(Context.SEARCH_SERVICE);
        MenuItem item = menu.findItem(R.id.action_search);
        SearchView searchView = (SearchView) MenuItemCompat.getActionView(item);
        searchView.setSearchableInfo(searchManager.getSearchableInfo(
                new ComponentName(getApplicationContext(), TabSearchActivity.class)));
